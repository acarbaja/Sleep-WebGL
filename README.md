...
This project was done in completion for my Wellesley College CS 307: Intro to Computer Graphics final. It's pretty neat. Requires brower to support WebGL. Homepage is description.html which is a Bootstrap edit.

In order to curve an XMLHttpsRequest (re: an error), please use this guide to run these files locally on your computer: https://threejs.org/docs/#manual/en/introduction/How-to-run-things-locally .
